...
//   box-shadow: ${({ scrolled }) =>
//     scrolled ? "0 4px 20px rgba(0, 0, 0, 0.15)" : "none"};
...
// //   align-items: center;
// //   padding: ${({ scrolled }) => scrolled ? '0.75rem 2.5rem' : '1.25rem 2.5rem'};
// //   max-width: 1500px;
// //   margin: 0 auto;
...
// //     padding: ${({ scrolled }) => scrolled ? '0.6rem 1rem' : '0.75rem 1rem'};
// //   }
// // `;
...
//   justify-content: space-between;
//   align-items: center;
//   padding: ${({ scrolled }) => scrolled ? '0.6rem 2.5rem' : '0.5rem 2.5rem'};  // Reduced padding
//   max-width: 1500px;
//   margin: 0 auto;
//   transition: all 0.3s ease;

//   @media (max-width: 1200px) {
//     padding: ${({ scrolled }) => scrolled ? '0.5rem 2rem' : '0.75rem 2rem'};
//   }

//   @media (max-width: 992px) {
//     padding: ${({ scrolled }) => scrolled ? '0.5rem 1.5rem' : '0.5rem 1.5rem'};
//   }

//   @media (max-width: 576px) {
//     padding: ${({ scrolled }) => scrolled ? '0.4rem 1rem' : '0.5rem 1rem'};
//   }
// `;
...
// const LogoImage = styled.img`
//   height: ${({ scrolled }) => scrolled ? '55px' : '65px'};  // Reduced logo size
//   object-fit: contain;
//   transition: all 0.3s ease;
...
//       bottom: 10px;
//       left: 1.5rem;
//       width: ${props => props.className?.includes('active') ? 'calc(100% - 3rem)' : '0'};
//     }
...
//     // In a real implementation, this would update your theme context
//   };
...
//             <LogoImage src={CodenicheLogo} alt="CodeNiche Logo" scrolled={scrolled} />
//           </LogoWrapper>
...
//                 <Button as="span" fullWidth>Contact Us</Button>
//               </Link>
//             </ContactButton>
...
//       {/* <FloatingContact scrolled={scrolled && !isOpen}>
//         <Link to="/contact">
//           <Button as="span" size="small">Get in Touch</Button>
//         </Link>
//       </FloatingContact> */}
//     </>
//   );
...
// //     darkMode 
// //       ? (scrolled ? '#121212' : 'rgba(18, 18, 18, 0.95)')
// //       : (scrolled ? '#ffffff' : 'rgba(255, 255, 255, 0.95)')};
// //   backdrop-filter: blur(10px);
// //   box-shadow: ${({ scrolled, darkMode }) =>
// //     scrolled ? (darkMode ? "0 4px 20px rgba(0, 0, 0, 0.3)" : "0 4px 20px rgba(0, 0, 0, 0.15)") : "none"};
// //   transition: all 0.4s ease;
// // `;
...
// //     width: 300px;
// //     height: 100vh;
// //     background-color: ${({ darkMode }) => darkMode ? '#1a1a2e' : '#f8f9fa'};
// //     flex-direction: column;
// //     justify-content: flex-start;
// //     padding-top: 5rem;
// //     transition: all 0.4s ease;
// //     box-shadow: ${({ darkMode }) => darkMode ? '-5px 0 20px rgba(0, 0, 0, 0.5)' : '-5px 0 20px rgba(0, 0, 0, 0.15)'};
// //     overflow-y: auto;
// //     z-index: 1001;
// //   }
// // `;
...
// //     if (darkMode) {
// //       return scrolled ? '#f5f5f5' : '#f5f5f5'; // Light text for dark mode
// //     } else {
// //       return scrolled ? '#333333' : '#333333'; // Dark text for light mode
// //     }
// //   }};
// //   font-weight: 600;
// //   font-family: 'Inter', sans-serif;
...
// //   &:hover,
// //   &.active {
// //     color: #ff6b00; // Accent color that works in both light and dark
// //   }
...
// //   @media (max-width: 992px) {
// //     padding: 1.25rem 1.5rem;
// //     color: ${({ darkMode }) => darkMode ? '#f5f5f5' : '#333333'};
// //     font-size: 18px;
// //     width: 100%;
// //     text-align: left;
...
// //   const toggleTheme = () => {
// //     setIsDarkMode(!isDarkMode);
// //     // This would update the theme throughout the app
// //     // You'll need to integrate with your app's theme context/state
...
// //     <>
// //       <Overlay isOpen={isOpen} onClick={closeMenu} />
// //       <HeaderContainer scrolled={scrolled} darkMode={isDarkMode}>
// //         <HeaderWrapper scrolled={scrolled}>
// //           <LogoWrapper to="/" onClick={closeMenu}>
// //             <LogoImage src={CodenicheLogo} alt="CodeNiche Logo" scrolled={scrolled} />
// //           </LogoWrapper>
...
// //           <Nav isOpen={isOpen} darkMode={isDarkMode}>
// //             <NavList>
// //               <NavItem darkMode={isDarkMode}>
// //                 <StyledNavLink
// //                   to="/"
// //                   onClick={closeMenu}
// //                   end
...
//     scrolled ? 'rgba(43, 45, 60, 0.8)' : 'transparent'};
...
//   justify-content: space-between;
//   align-items: center;
//   padding: ${({ scrolled }) => scrolled ? '0.6rem 2.5rem' : '0.5rem 2.5rem'};
//   max-width: 1500px;
//   margin: 0 auto;
//   transition: all 0.3s ease;
...
// const LogoImage = styled.img`
//   height: ${({ scrolled }) => scrolled ? '55px' : '65px'};
//   object-fit: contain;
//   transition: all 0.3s ease;
